...
public class SmsLogDaoImpl extends BaseDao implements SmsLogDao{
	...
	public List<SmsLog> querySmsSend(Integer i) {
		@SuppressWarnings("unchecked")
		List<SmsLog> list = getSqlMapClientTemplate().queryForList(buildId(SQL_PREFIX, "querySmsSend"), i);
		return list;
	}
	...
	public Integer recoverStatus(Integer fromStatus, Integer toStatus) {
		...
		return (Integer) getSqlMapClientTemplate().update(buildId(SQL_PREFIX,"recoverStatus"),rootMap);
	}

...
public class SmsLogController extends BaseController {
	...
	public ModelAndView querySms(HttpServletRequest request,
		...
		page = smsService.pageLog(from, to, sendStatus, page);

		return printJson(page, out);
	}
	
	@RequestMapping
	public ModelAndView deleteSms(HttpServletRequest request,Map<String, Object> out,Integer id){
	...
	@RequestMapping
	public ModelAndView resendSms(HttpServletRequest request,Map<String, Object> out,Integer id){
